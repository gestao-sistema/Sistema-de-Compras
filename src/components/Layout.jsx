...
const NAV_NOVITAH = ['dashboard', 'curva_abc', 'compras', 'pedidos', 'lancamentos', 'fornecedores', 'clientes']
...
const NAV = [
  ...
  { to: '/lancamentos', label: 'Lançamentos',              Icon: IconCalendar,  chave: 'lancamentos' },
